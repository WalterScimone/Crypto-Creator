...
export default class TokenInfo {
     ...
     * @returns {TokenInfo}
     */
    static _fromProtobuf(info: proto.ITokenInfo, ledgerId?: (string | null) | undefined): TokenInfo;
    /**
     ...
     * @readonly
     */
    readonly kycKey: import("@hashgraph/cryptography").Key | null;
    /**
     * The key which can freeze or unfreeze an account for token transactions. If empty, freezing is not possible
     *
     * @readonly
     */
    readonly freezeKey: import("@hashgraph/cryptography").Key | null;
    /**
     * The key which can wipe token balance of an account. If empty, wipe is not possible
     *
     * @readonly
     */
    readonly wipeKey: import("@hashgraph/cryptography").Key | null;
    /**
     * The key which can change the supply of a token. The key is used to sign Token Mint/Burn operations
     *
     * @readonly
     */
    readonly supplyKey: import("@hashgraph/cryptography").Key | null;
    feeScheduleKey: import("@hashgraph/cryptography").Key | null;
    /**
