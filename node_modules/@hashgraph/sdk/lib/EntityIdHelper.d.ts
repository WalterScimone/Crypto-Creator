 ...
 */
export function constructor(props: number | Long | IEntityId, realm?: (number | null | Long) | undefined, num?: (number | null | Long) | undefined): IEntityIdResult;
/**
 ...
 */
export function _parseAddress(ledgerId: string, addr: string): ParseAddressResult;
/**
 ...
 * @returns {string}
 */
export function _checksum(ledgerId: string, addr: string): string;
