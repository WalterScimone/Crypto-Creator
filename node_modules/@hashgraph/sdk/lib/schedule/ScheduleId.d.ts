...
export default class ScheduleId {
     ...
     * @returns {ScheduleId}
     */
    static _fromProtobuf(id: proto.IScheduleID, ledgerId?: (string | null) | undefined): ScheduleId;
    /**
     ...
     * @param {Client} client
     */
    _setNetworkWith(client: import("../client/Client.js").default<any, any>): void;
    /**
     * @internal
     * @param {string} ledgerId
     */
    _setNetwork(ledgerId: string): void;
    /**
     * @param {Client} client
     */
