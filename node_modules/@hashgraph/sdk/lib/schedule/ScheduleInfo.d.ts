...
export default class ScheduleInfo {
     ...
     */
    static _fromProtobuf(info: proto.IScheduleInfo, ledgerId?: (string | null) | undefined): ScheduleInfo;
    /**
     * @private
     * @param {object} props
     ...
     * @readonly
     */
    readonly signers: import("@hashgraph/cryptography").KeyList | null;
    /**
     *
     * @readonly
     */
...
export type KeyList = import("@hashgraph/cryptography").KeyList;
