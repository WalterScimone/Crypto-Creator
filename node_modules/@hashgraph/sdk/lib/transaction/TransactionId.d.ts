...
export default class TransactionId {
     ...
     * @returns {TransactionId}
     */
    static _fromProtobuf(id: proto.ITransactionID, networkName?: (string | null) | undefined): TransactionId;
    /**
     ...
     */
    constructor(accountId: AccountId | null, validStart: Timestamp | null, scheduled?: boolean | null);
    /**
